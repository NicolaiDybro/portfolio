<template>
    <div id="contact" class="flex items-center justify-center pt-12">
      <h1 class="xl:text-4xl font-bold lg:tracking-tight">Contact</h1>
    </div>
    <div class="flex items-center justify-center mt-1">
    <h1 class="xl:text-1xl lg:tracking-tight">Reach out to make the first move!</h1>
  </div>
