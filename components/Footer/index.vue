<template>
  ...
  <div class="container px-6 pt-6">
    <div class="mb-6 flex justify-center">
      <a
        href="https://www.facebook.com/profile.php?id=100012057609070"
        type="button"
      ...
      <a
        href="https://www.instagram.com/nicolai.dybro/"
        type="button"
        class="m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0"
        data-te-ripple-init
        data-te-ripple-color="light">
  ...
  <!--Copyright section-->
  <div
    class="w-full p-4 bg-neutral-900 border-t-2 bordertext-center border-sky-800">
    © 2024 Copyright:
    <a class="text-whitehite" href="https://nicolaidybro.com/"
      >Nicolai Dybro</a
    >
  </div>
</footer>
