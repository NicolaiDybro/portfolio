<template>
    <div ref="reviews" class="flex items-center justify-center pt-12">
      <h1 class="xl:text-4xl font-bold lg:tracking-tight">My reviews</h1>
                    ...
                    <div class="w-full mx-auto rounded-lg backdrop-filter backdrop-blur-sm border border-sky-600 p-5 text-gray-100 font-light mb-6">
                        <div class="w-full flex mb-4 items-center">
                            ...
                            <div class="flex-grow pl-3">
                                <h6 class="font-bold text-sm uppercase text-gray-100">Peter D</h6>
                            </div>
                        </div>
                        <div class="w-full">
                            <p class="text-sm leading-tight"><span class="text-lg leading-none italic font-bold text-gray-100 mr-1">"</span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos sunt ratione dolor exercitationem minima quas itaque saepe quasi architecto vel! Accusantium, vero sint recusandae cum tempora nemo commodi soluta deleniti.<span class="text-lg leading-none italic font-bold text-gray-400 ml-1">"</span></p>
                        </div>
                    </div>
                    <div class="w-full mx-auto rounded-lg backdrop-filter backdrop-blur-sm border border-sky-600 border p-5 text-gray-100 font-light mb-6">
                        <div class="w-full flex mb-4 items-center">
                            <div class="overflow-hidden rounded-full w-10 h-10 bg-gray-50 border border-gray-200">
                                <img src="https://i.pravatar.cc/100?img=1" alt="">
                            </div>
